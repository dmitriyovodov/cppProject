...
/// \brief Функция window_callback отслеживает состояние окна работающего приложения
///
...
/// \brief Функция WinMain запускает в себе все события игрового процесса. Аналог main в обычных c++ программах.
/// 
